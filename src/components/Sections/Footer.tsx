  ...
  <div className="relative bg-neutral-900 px-4 pb-6 pt-12 sm:px-8 sm:pb-8 sm:pt-14">
    ...
    <div className="flex flex-col items-center gap-y-6">
      ...
      <a
        ...
        <span>
          Provided by <span className="text-white">Alaa</span>
          <span className="italic text-yellow">Snteha</span>
        </span>
      </a>
      <span className="text-sm text-neutral-700">© Copyright {currentYear} Alaa Snteha</span>
    </div>
  </div>
));
